[![Minecraft Plugin][Project Logo]][Website]
What is Minecraft Plugin?
----------------------

Copyright &copy; 2011, SpoutDev <http://www.getspout.org>  
Minecraft Plugin is licensed under [GNU LESSER GENERAL PUBLIC LICENSE Version 3][License], but with a 
...
Who is SpoutDev?
----------------
SpoutDev is the team behind Spout, SpoutAPI, Spoutcraft, SpoutcraftAPI, Minecraft Plugin, and Spoutcraft Launcher.  
...
Compiling
---------
Minecraft Plugin uses Maven to handle its dependencies.
...
[GitHub]: https://github.com/SpoutDev/Minecraft Plugin
...
[Donate]: https://www.paypal.com/cgi-bin/webscr?hosted_button_id=QNJH72R72TZ64&item_name=Minecraft+Plugin+donation+%28from+github.com%29&cmd=_s-xclick
