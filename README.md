...
* Number of commits in a pull request should be kept to *one commit* and related commits should be squashed.
* You may have more than one commit in a pull request if the commits are separate changes.
