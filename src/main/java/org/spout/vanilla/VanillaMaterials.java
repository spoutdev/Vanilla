...
public final class VanillaMaterials {
	...
	public static final BlockMaterial BED_BLOCK = new Solid("Bed", 26).setHardness(0.2F).setResistance(0.3F).setDrop(355);
	...
	public static final BlockMaterial WEB = new Solid("Cobweb", 30).setHardness(4.0F).setResistance(20.0F).setDrop(287);
	public static final BlockMaterial DEAD_SHRUB = new LongGrass("Dead Grass", 31, 0).setHardness(0.0F).setResistance(0.0F).setDrop(0);
	public static final BlockMaterial TALL_GRASS = new LongGrass("Tall Grass", 31, 1).setHardness(0.0F).setResistance(0.0F).setDrop(0);
	public static final BlockMaterial FERN = new LongGrass("Fern", 31, 2).setHardness(0.0F).setResistance(0.0F).setDrop(0);
	public static final BlockMaterial DEAD_BUSH = new LongGrass("Dead Shrubs", 32, 0).setHardness(0.0F).setResistance(0.0F).setDrop(0);
	public static final BlockMaterial PISTON_BASE = new Solid("Piston", 33).setResistance(0.8F);
	public static final BlockMaterial PISTON_EXTENSION = new Solid("Piston (Head)", 34).setResistance(0.8F).setDrop(33); // TODO: Check sticky
	...
	public static final BlockMaterial MOVED_BY_PISTON = new Solid("Moved By Piston", 36).setResistance(0.0F).setDrop(0); // TODO: ???
	...
	public static final BlockMaterial STONE_DOUBLE_SLABS = new DoubleSlab("Stone Double Slab", 43, 0).setHardness(2.0F).setResistance(10.0F).setDrop(44, 0).setDropCount(2);
	public static final BlockMaterial SANDSTONE_DOUBLE_SLABS = new DoubleSlab("Sandstone Double Slab", 43, 1).setHardness(2.0F).setResistance(10.0F).setDrop(44, 1).setDropCount(2);
	public static final BlockMaterial WOODEN_DOUBLE_SLABS = new DoubleSlab("Wooden Double Slab", 43, 2).setHardness(2.0F).setResistance(10.0F).setDrop(44, 2).setDropCount(2);
	public static final BlockMaterial COBBLESTONE_DOUBLE_SLABS = new DoubleSlab("Cobblestone Double Slab", 43, 3).setHardness(2.0F).setResistance(10.0F).setDrop(44, 3).setDropCount(2);
	public static final BlockMaterial BRICK_DOUBLE_SLABS = new DoubleSlab("Brick Double Slab", 43, 4).setHardness(2.0F).setResistance(10.0F).setDrop(44, 4).setDropCount(2);
	public static final BlockMaterial STONE_BRICK_DOUBLE_SLABS = new DoubleSlab("Stone Brick Double Slab", 43, 5).setHardness(2.0F).setResistance(10.0F).setDrop(44, 5).setDropCount(2);
	...
	public static final BlockMaterial BOOKSHELF = new Solid("Bookshelf", 47).setHardness(1.5F).setResistance(2.5F).setDrop(340).setDropCount(3);
	...
	public static final BlockMaterial FIRE = new Solid("Fire", 51).setHardness(0.0F).setResistance(0.0F).setLightLevel(15).setDrop(0);
	public static final BlockMaterial MONSTER_SPAWNER = new Solid("MonsterEntity Spawner", 52).setHardness(5.0F).setResistance(8.3F).setDrop(0);
	...
	public static final BlockMaterial REDSTONE_WIRE = new RedstoneWire("Redstone Wire", 55, 0).setHardness(0.0F).setResistance(0.0F).setDrop(331);
	...
	public static final BlockMaterial SIGN_POST = new Solid("Sign Post", 63).setHardness(1.0F).setResistance(1.6F).setDrop(323);
	public static final BlockMaterial WOODEN_DOOR_BLOCK = new DoorBlock("Wooden Door", 64, true).setHardness(3.0F).setDrop(324);
	...
	public static final BlockMaterial SNOW = new Solid("Snow", 78).setHardness(0.1F).setResistance(0.2F).setDrop(0); // TODO: Make shovels drop snowballs
	public static final BlockMaterial ICE = new Ice("Ice", 79).setHardness(0.5F).setResistance(0.8F).setDrop(0);
	...
	public static final BlockMaterial CLAY_BLOCK = new Solid("Clay Block", 82).setHardness(0.6F).setResistance(1.0F).setDrop(337).setDropCount(4);
	...
	public static final BlockMaterial REDSTONE_REPEATER_OFF = new Solid("Redstone Repeater", 93).setHardness(0.0F).setResistance(0.0F).setDrop(356);
	public static final BlockMaterial REDSTONE_REPEATER_ON = new Solid("Redstone Repeater (On)", 94).setHardness(0.0F).setResistance(0.0F).setLightLevel(9).setDrop(356);
	...
	public static final BlockMaterial SILVERFISH_STONE = new Solid("Silverfish Stone", 97).setHardness(0.75F).setResistance(10.0F).setDrop(4); // TODO: Get drop item based on data //Placeholder, block resistance unknown
	...
	public static final BlockMaterial MYCELIUM = new Solid("Mycelium", 110).setHardness(0.6F).setResistance(0.8F).setDrop(3);
	...
	public static final BlockMaterial END_PORTAL = new Solid("End Portal", 119).setHardness(-1.0F).setResistance(6000000.0F).setLightLevel(1).setDrop(0);
	public static final BlockMaterial END_PORTAL_FRAME = new Solid("End Portal Frame", 120).setHardness(-1.0F).setDrop(0);
	...
	public static final BlockMaterial REDSTONE_LAMP_ON = new Solid("Redstone Lamp (On)", 124).setHardness(0.3F).setResistance(0.5F).setLightLevel(15).setDrop(123); //Placeholder Values
	/*
	 * Items
	 */
