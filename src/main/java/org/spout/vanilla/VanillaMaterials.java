...
public final class VanillaMaterials {
	...
	public static final GenericBlock STONE = register(new Solid("Stone", 1).setHardness(1.5F).setResistance(10.0F));
	public static final GenericBlock GRASS = register(new Grass("Grass").setHardness(0.6F).setResistance(0.8F));
	public static final GenericBlock DIRT = register(new Solid("Dirt", 3).setHardness(0.5F).setResistance(0.8F));
	public static final GenericBlock COBBLESTONE = register(new Solid("Cobblestone", 4).setHardness(2.0F).setResistance(10.0F));
	public static final GenericBlock WOOD = register(new Solid("Wooden Planks", 5).setHardness(2.0F).setResistance(5.0F));
	public static final Sapling SAPLING = Sapling.DEFAULT;	
	public static final GenericBlock BEDROCK = register(new Solid("Bedrock", 7).setResistance(6000000.0F));
	public static final BlockMaterial WATER = register(new GenericLiquid("Water", 8, true).setHardness(100.0F).setResistance(166.7F).setOpacity((byte) 2));
	public static final BlockMaterial STATIONARY_WATER = register(new GenericLiquid("Stationary Water", 9, false).setHardness(100.0F).setResistance(166.7F).setOpacity((byte) 2));
	public static final GenericBlock LAVA = register(new GenericLiquid("Lava", 10, true).setHardness(0.0F).setLightLevel(15).setResistance(0.0F));
	public static final GenericBlock STATIONARY_LAVA = register(new GenericLiquid("Stationary Lava", 11, false).setHardness(100.0F).setLightLevel(15).setResistance(166.7F));
	public static final GenericBlock SAND = register(new Solid("Sand", 12, true).setHardness(0.5F).setResistance(0.8F));
	public static final GenericBlock GRAVEL = register(new Gravel("Gravel").setHardness(0.6F).setResistance(1.0F));
	public static final GenericBlock GOLD_ORE = register(new Ore("Gold Ore", 14).setHardness(3.0F).setResistance(5.0F));
	public static final GenericBlock IRON_ORE = register(new Ore("Iron Ore", 15).setHardness(3.0F).setResistance(5.0F));
	public static final GenericBlock COAL_ORE = register(new Ore("Coal Ore", 16).setHardness(3.0F).setResistance(5.0F));
	public static final Tree LOG = Tree.DEFAULT;
	public static final Leaves LEAVES = Leaves.DEFAULT;
	public static final GenericBlock SPONGE = register(new Solid("Sponge", 19).setHardness(0.6F).setResistance(1.0F));
	public static final GenericBlock GLASS = register(new Solid("Glass", 20).setHardness(0.3F).setResistance(0.5F));
	public static final GenericBlock LAPIS_ORE = register(new Ore("Lapis Lazuli Ore", 21).setMinDropCount(4).setMaxDropCount(8).setHardness(3.0F).setResistance(5.0F));
	public static final GenericBlock LAPIS_BLOCK = register(new Solid("Lapis Lazuli Block", 22).setHardness(3.0F).setResistance(5.0F));
	public static final GenericBlock DISPENSER = register(new Solid("Dispenser", 23).setHardness(3.5F).setResistance(5.8F));
	public static final GenericBlock SANDSTONE = register(new Solid("Sandstone", 24).setHardness(0.8F).setResistance(1.3F));
	public static final GenericBlock NOTEBLOCK = register(new Solid("Note Block", 25).setHardness(0.8F).setResistance(1.3F));
	public static final GenericBlock BED_BLOCK = register(new Solid("Bed", 26).setHardness(0.2F).setResistance(0.3F));
	public static final GenericBlock POWERED_RAIL = register(new MinecartTrackPowered("Powered Rail", 27).setHardness(0.7F).setResistance(1.2F));
	public static final GenericBlock DETECTOR_RAIL = register(new MinecartTrackDetector("Detector Rail", 28).setHardness(0.7F).setResistance(1.2F));
	public static final GenericBlock PISTON_STICKY_BASE = register(new Solid("Sticky Piston", 29).setResistance(0.8F));
	public static final GenericBlock WEB = register(new Solid("Cobweb", 30).setHardness(4.0F).setResistance(20.0F));
	/** Warning: This is NOT the data=0 sub-material! */
	public static final TallGrass TALL_GRASS = TallGrass.TALL_GRASS;
	public static final GenericBlock DEAD_BUSH = register(new LongGrass("Dead Shrubs", 32).setHardness(0.0F).setResistance(0.0F));
	public static final GenericBlock PISTON_BASE = register(new Solid("Piston", 33).setResistance(0.8F));
	public static final GenericBlock PISTON_EXTENSION = register(new Solid("Piston (Head)", 34).setResistance(0.8F));
	public static final Wool WOOL = Wool.WHITE;
	public static final GenericBlock MOVED_BY_PISTON = register(new Solid("Moved By Piston", 36).setResistance(0.0F));
	public static final GenericBlock DANDELION = register(new GroundAttachable("Dandelion", 37).setHardness(0.0F).setResistance(0.0F));
	public static final GenericBlock ROSE = register(new GroundAttachable("Rose", 38).setHardness(0.0F).setResistance(0.0F));
	public static final GenericBlock BROWN_MUSHROOM = register(new GroundAttachable("Brown Mushroom", 39).setHardness(0.0F).setResistance(0.0F).setLightLevel(1));
	public static final GenericBlock RED_MUSHROOM = register(new GroundAttachable("Red Mushroom", 40).setHardness(0.0F).setResistance(0.0F));
	public static final GenericBlock GOLD_BLOCK = register(new Solid("Gold Block", 41).setHardness(3.0F).setResistance(10.0F));
	public static final GenericBlock IRON_BLOCK = register(new Solid("Iron Block", 42).setHardness(5.0F).setResistance(10.0F));
	public static final DoubleSlab DOUBLE_SLABS = DoubleSlab.STONE;
	public static final Slab SLAB = Slab.STONE;
	public static final GenericBlock BRICK = register(new Solid("Brick Block", 45).setHardness(2.0F).setResistance(10.0F));
	public static final GenericBlock TNT = register(new Solid("TNT", 46).setHardness(0.0F).setResistance(0.0F));
	public static final GenericBlock BOOKSHELF = register(new Solid("Bookshelf", 47).setHardness(1.5F).setResistance(2.5F));
	public static final GenericBlock MOSS_STONE = register(new Solid("Moss Stone", 48).setHardness(2.0F).setResistance(10.0F).setResistance(10.0F));
	public static final GenericBlock OBSIDIAN = register(new Solid("Obsidian", 49).setHardness(50.0F).setResistance(2000.0F));
	public static final GenericBlock TORCH = register(new WallAttachable("Torch", 50).setHardness(0.0F).setResistance(0.0F).setLightLevel(14));
	public static final GenericBlock FIRE = register(new Solid("Fire", 51).setHardness(0.0F).setResistance(0.0F).setLightLevel(15));
	public static final GenericBlock MONSTER_SPAWNER = register(new Solid("MonsterEntity Spawner", 52).setHardness(5.0F).setResistance(8.3F));
	public static final GenericBlock WOODEN_STAIRS = register(new Solid("Wooden Stairs", 53).setResistance(3.0F));
	public static final GenericBlock CHEST = register(new Solid("Chest", 54).setHardness(2.5F).setResistance(4.2F));
	public static final GenericBlock REDSTONE_WIRE = register(new RedstoneWire("Redstone Wire", 55).setHardness(0.0F).setResistance(0.0F));
	public static final GenericBlock DIAMOND_ORE = register(new Solid("Diamond Ore", 56).setHardness(3.0F).setResistance(5.0F));
	public static final GenericBlock DIAMOND_BLOCK = register(new Solid("Diamond Block", 57).setHardness(5.0F).setResistance(10.0F));
	public static final GenericBlock CRAFTING_TABLE = register(new Solid("Crafting Table", 58).setHardness(4.2F));
	public static final GenericBlock WHEATCROP = register(new WheatCrop("Wheat Crop").setResistance(0.0F));
	public static final GenericBlock FARMLAND = register(new Solid("Farmland", 60).setHardness(0.6F).setResistance(1.0F));
	public static final GenericBlock FURNACE = register(new Solid("Furnace", 61).setHardness(3.5F).setResistance(5.8F));
	public static final GenericBlock BURNINGFURNACE = register(new Solid("Burning Furnace", 62).setHardness(3.5F).setResistance(5.8F).setLightLevel(13));
	public static final GenericBlock SIGN_POST = register(new Solid("Sign Post", 63).setHardness(1.0F).setResistance(1.6F));
	public static final DoorBlock WOODEN_DOOR_BLOCK = (DoorBlock) register(new DoorBlock("Wooden Door", 64, true).setHardness(3.0F));
	public static final GenericBlock LADDERS = register(new Solid("Ladders", 65).setHardness(0.4F).setResistance(0.7F));
	public static final GenericBlock RAILS = register(new MinecartTrack("Rails", 66).setHardness(0.7F).setResistance(1.2F));
	public static final GenericBlock COBBLESTONE_STAIRS = register(new Solid("Cobblestone Stairs", 67).setResistance(10.0F));
	public static final GenericBlock WALL_SIGN = register(new Solid("Wall Sign", 68).setHardness(1.0F));
	public static final GenericBlock LEVER = register(new Solid("Lever", 69).setHardness(0.5F).setResistance(1.7F));
	public static final GenericBlock STONE_PRESSURE_PLATE = register(new Solid("Stone Pressure Plate", 70).setHardness(0.5F).setResistance(0.8F));
	...
	public static final GenericBlock WOODEN_PRESSURE_PLATE = register(new Solid("Wooden Pressure Plate", 72).setHardness(0.5F).setResistance(0.8F));
	public static final GenericBlock REDSTONE_ORE = register(new Ore("Redstone Ore", 73).setMinDropCount(4).setMaxDropCount(5).setHardness(3.0F).setResistance(5.0F));
	public static final GenericBlock GLOWING_REDSTONE_ORE = register(new Ore("Glowing Redstone Ore", 74).setMinDropCount(4).setMaxDropCount(5).setHardness(3.0F).setResistance(5.0F).setLightLevel(3));
	public static final GenericBlock REDSTONE_TORCH_OFF = register(new RedstoneTorch("Redstone Torch", 75, false).setHardness(0.0F).setResistance(0.0F));
	public static final GenericBlock REDSTONE_TORCH_ON = register(new RedstoneTorch("Redstone Torch (On)", 76, true).setHardness(0.0F).setResistance(0.0F).setLightLevel(7));
	public static final GenericBlock STONE_BUTTON = register(new Solid("Stone Button", 77).setHardness(0.5F).setResistance(0.8F));
	public static final GenericBlock SNOW = register(new Solid("Snow", 78).setHardness(0.1F).setResistance(0.2F));
	public static final GenericBlock ICE = register(new Ice("Ice", 79).setHardness(0.5F).setResistance(0.8F));
	public static final GenericBlock SNOW_BLOCK = register(new Solid("Snow Block", 80).setHardness(0.2F).setResistance(0.3F));
	public static final GenericBlock CACTUS = register(new Cactus("Cactus", 81).setHardness(0.4F).setResistance(0.7F));
	public static final GenericBlock CLAY_BLOCK = register(new Solid("Clay Block", 82).setHardness(0.6F).setResistance(1.0F));
	public static final GenericBlock SUGAR_CANE_BLOCK = register(new Solid("Sugar Cane", 83).setHardness(0.0F).setResistance(0.0F));
	public static final GenericBlock JUKEBOX = register(new Solid("Jukebox", 84).setHardness(2.0F).setResistance(10.0F));
	public static final GenericBlock FENCE = register(new Solid("Fence", 85).setResistance(5.0F).setResistance(5.0F));
	public static final GenericBlock PUMPKIN = register(new Solid("Pumpkin", 86).setHardness(1.0F).setResistance(1.7F));
	public static final GenericBlock NETHERRACK = register(new Solid("Netherrack", 87).setHardness(0.7F));
	public static final GenericBlock SOUL_SAND = register(new Solid("Soul Sand", 88).setHardness(0.5F).setResistance(0.8F));
	public static final GenericBlock GLOWSTONE_BLOCK = register(new Ore("Glowstone Block", 89).setMinDropCount(2).setMaxDropCount(4).setHardness(0.3F).setResistance(0.5F).setLightLevel(15));
	public static final GenericBlock PORTAL = register(new Solid("Portal", 90).setHardness(-1.0F).setResistance(0.0F).setLightLevel(11));
	public static final GenericBlock JACK_O_LANTERN = register(new Solid("Jack 'o' Lantern", 91).setHardness(1.0F).setResistance(1.7F).setLightLevel(15));
	public static final GenericBlock CAKE_BLOCK = register(new Solid("Cake Block", 92).setHardness(0.5F).setResistance(0.8F));
	public static final GenericBlock REDSTONE_REPEATER_OFF = register(new Solid("Redstone Repeater", 93).setHardness(0.0F).setResistance(0.0F));
	public static final GenericBlock REDSTONE_REPEATER_ON = register(new Solid("Redstone Repeater (On)", 94).setHardness(0.0F).setResistance(0.0F).setLightLevel(9));
	public static final GenericBlock LOCKED_CHEST = register(new Solid("Locked Chest", 95).setHardness(0.0F).setResistance(0.0F).setLightLevel(15));
	public static final GenericBlock TRAPDOOR = register(new Solid("Trapdoor", 96).setHardness(3.0F).setResistance(5.0F));
	public static final GenericBlock SILVERFISH_STONE = register(new Solid("Silverfish Stone", 97).setHardness(0.75F).setResistance(10.0F)); //Placeholder, block resistance unknown
	public static final StoneBrick STONE_BRICK = StoneBrick.STONE;
	public static final GenericBlock HUGE_BROWN_MUSHROOM = register(new Ore("Huge Brown Mushroom", 99).setMinDropCount(0).setMaxDropCount(2).setHardness(0.2F).setResistance(0.3F)); //Placeholder, block resistance unknown
	public static final GenericBlock HUGE_RED_MUSHROOM = register(new Ore("Huge Red Mushroom", 100).setMinDropCount(0).setMaxDropCount(2).setHardness(0.2F).setResistance(0.3F)); //Placeholder, block resistance unknown
	public static final GenericBlock IRON_BARS = register(new Solid("Iron Bars", 101).setHardness(5.0F).setResistance(10.0F));
	public static final GenericBlock GLASS_PANE = register(new Solid("Glass Pane", 102).setHardness(0.3F).setResistance(0.3F)); //Placeholder, block resistance unknown
	public static final GenericBlock MELON = register(new Ore("Melon", 103).setMinDropCount(3).setMaxDropCount(7).setHardness(1.0F).setResistance(1.7F));
	public static final GenericBlock PUMPKIN_STEM = register(new Solid("Pumpkin Stem", 104).setHardness(0.0F).setResistance(0.0F));
	public static final GenericBlock MELON_STEM = register(new Solid("Melon Stem", 105).setHardness(0.0F).setResistance(0.3F));
	public static final GenericBlock VINES = register(new Solid("Vines", 106).setHardness(0.2F).setResistance(0.3F));
	public static final GenericBlock FENCE_GATE = register(new Solid("Fence Gate", 107).setHardness(2.0F).setResistance(3.0F));
	public static final GenericBlock BRICK_STAIRS = register(new Solid("Brick Stairs", 108).setResistance(10.0F));
	public static final GenericBlock STONE_BRICK_STAIRS = register(new Solid("Stone Brick Stairs", 109).setResistance(10.0F));
	public static final GenericBlock MYCELIUM = register(new Solid("Mycelium", 110).setHardness(0.6F).setResistance(0.8F));
	public static final GenericBlock LILY_PAD = register(new Solid("Lily Pad", 111).setHardness(0.0F).setResistance(0.3F)); //Placeholder, block resistance unknown
	public static final GenericBlock NETHER_BRICK = register(new Solid("Nether Brick", 112).setHardness(2.0F).setResistance(10.0F));
	public static final GenericBlock NETHER_BRICK_FENCE = register(new Solid("Nether Brick Fence", 113).setHardness(2.0F).setResistance(10.0F));
	public static final GenericBlock NETHER_BRICK_STAIRS = register(new Solid("Nether Brick Stairs", 114).setResistance(10.0F));
	public static final GenericBlock NETHER_WART_BLOCK = register(new Solid("Nether Wart", 115).setResistance(0.0F));
	public static final GenericBlock ENCHANTMENT_TABLE = register(new Solid("Enchantment Table", 116).setHardness(5.0F).setResistance(2000.0F));
	public static final GenericBlock BREWING_STAND_BLOCK = register(new Solid("Brewing Stand", 117).setHardness(0.5F).setResistance(0.8F).setLightLevel(1));
	public static final GenericBlock CAULDRON_BLOCK = register(new Solid("Cauldron", 118).setHardness(2.0F).setResistance(3.3F));
	public static final GenericBlock END_PORTAL = register(new Solid("End Portal", 119).setHardness(-1.0F).setResistance(6000000.0F).setLightLevel(1));
	public static final GenericBlock END_PORTAL_FRAME = register(new Solid("End Portal Frame", 120).setHardness(-1.0F));
	public static final GenericBlock END_STONE = register(new Solid("End Stone", 121).setHardness(3.0F).setResistance(15.0F));
	public static final GenericBlock DRAGON_EGG = register(new Solid("Dragon Egg", 122).setHardness(3.0F).setResistance(15.0F).setLightLevel(1));
	public static final GenericBlock REDSTONE_LAMP_OFF = register(new Solid("Redstone Lamp", 123).setHardness(0.3F).setResistance(0.5F)); //Placeholder Values
	public static final GenericBlock REDSTONE_LAMP_ON = register(new Solid("Redstone Lamp (On)", 124).setHardness(0.3F).setResistance(0.5F).setLightLevel(15)); //Placeholder Values
