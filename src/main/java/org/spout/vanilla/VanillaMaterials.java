...
public final class VanillaMaterials {
	...
	public static final BlockMaterial POWERED_RAIL = new MinecartTrackPowered("Powered Rail", 27).setHardness(0.7F);
	public static final BlockMaterial DETECTOR_RAIL = new MinecartTrackDetector("Detector Rail", 28).setHardness(0.7F);
	...
	public static final BlockMaterial RAILS = new MinecartTrack("Rails", 66).setHardness(0.7F);
	...
	public static final DoorBlock IRON_DOOR_BLOCK = (DoorBlock) new DoorBlock("Iron Door", 71, false).setHardness(5.0F);
