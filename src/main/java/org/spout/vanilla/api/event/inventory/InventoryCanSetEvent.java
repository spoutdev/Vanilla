...
/**
 * Thrown when checking if an ItemStack can be set into an empty inventory slot, or when swapping items.<br/>
 * This event is thrown even when a slot is being set when the system would normally not allow it.
 */
