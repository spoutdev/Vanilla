 ...
 */
public class MagmaCube extends EntityComponent {
	public MagmaCube() {
	}

	@Override
	public void onAttached() {
		getHolder().getNetworkComponent().setEntityProtocol(VanillaPlugin.VANILLA_PROTOCOL_ID, new MagmaCubeEntityProtocol());
	}
}
