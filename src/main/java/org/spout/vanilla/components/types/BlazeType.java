...
public class BlazeType extends EntityType {
	public BlazeType() {
		super(VanillaComponents.BLAZE);
	}

	@Override
	public void init(Entity typed) {
		typed.getNetworkComponent().setEntityProtocol(VanillaPlugin.VANILLA_PROTOCOL_ID, new BlazeEntityProtocol());
	}
}
