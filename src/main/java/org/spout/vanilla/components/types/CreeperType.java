...
public class CreeperType extends EntityType {
	public CreeperType() {
		super(VanillaComponents.CREEPER);
	}

	@Override
	public void init(Entity typed) {
		typed.getNetworkComponent().setEntityProtocol(VanillaPlugin.VANILLA_PROTOCOL_ID, new CreeperEntityProtocol());
	}
}
