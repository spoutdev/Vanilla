...
public class GhastType extends EntityType {
	public GhastType() {
		super(VanillaComponents.GHAST);
	}

	@Override
	public void init(Entity typed) {
		typed.getNetworkComponent().setEntityProtocol(VanillaPlugin.VANILLA_PROTOCOL_ID, new GhastEntityProtocol());
	}
}
