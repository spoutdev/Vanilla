...
public class SuffocationComponent extends LogicRunnable<Living> {
	private int airTicks = 0;
	private int maxAirTicks = 300;

	public SuffocationComponent(Living parent, LogicPriority priority) {
		super(parent, priority);
	}

	@Override
	public void onRegistration() {
		airTicks = getParent().data().get(VanillaData.AIR_TICKS);
	}

	@Override
	public void onUnregistration() {
		getParent().data().put(VanillaData.AIR_TICKS, airTicks);
	}
