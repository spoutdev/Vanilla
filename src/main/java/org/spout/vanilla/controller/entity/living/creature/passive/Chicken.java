 ...
 */
package org.spout.vanilla.controller.entity.living.creature.passive;
...
import org.spout.vanilla.controller.entity.living.creature.Passive;
...
public class Chicken extends Creature implements Passive {
	...
	public void onAttached() {
		super.onAttached();
		parent = getParent();
		parent.setMaxHealth(4);
		parent.setHealth(4, new HealthChangeReason(HealthChangeReason.Type.SPAWN));
	}
