...
public class VanillaData {
	...
	public static final DefaultedKey<AnvilInventory> ANVIL_INVENTORY = new DefaultedKeyFactory<AnvilInventory>("inventory", AnvilInventory.class);
	public static final DefaultedKey<BeaconInventory> BEACON_INVENTORY = new DefaultedKeyFactory<BeaconInventory>("inventory", BeaconInventory.class);
	public static final DefaultedKey<BrewingStandInventory> BREWER_INVENTORY = new DefaultedKeyFactory<BrewingStandInventory>("inventory", BrewingStandInventory.class);
	...
	public static final DefaultedKey<DispenserInventory> DISPENSER_INVENTORY = new DefaultedKeyFactory<DispenserInventory>("inventory", DispenserInventory.class);
	public static final DefaultedKey<EnchantmentTableInventory> ENCHANT_TABLE_INVENTORY = new DefaultedKeyFactory<EnchantmentTableInventory>("inventory", EnchantmentTableInventory.class);
	public static final DefaultedKey<JukeboxInventory> JUKEBOX_INVENTORY = new DefaultedKeyFactory<JukeboxInventory>("inventory", JukeboxInventory.class);
