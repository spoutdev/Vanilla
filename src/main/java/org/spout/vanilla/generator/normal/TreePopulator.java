...
public class TreePopulator implements Populator {
    ...
    public void generateSmallTree(Chunk c, Point point) {
        ...
        // Third leaves layer
    	c.setBlockId(x+1, y+3, z, leaves, world);
    	c.setBlockId(x-1, y+3, z, leaves, world);
    	c.setBlockId(x, y+3, z+1, leaves, world);
    	c.setBlockId(x, y+3, z-1, leaves, world);
    	c.setBlockId(x+1, y+3, z+1, leaves, world);
    	c.setBlockId(x+1, y+3, z-1, leaves, world);
    	c.setBlockId(x-1, y+3, z-1, leaves, world);
    	c.setBlockId(x-1, y+3, z+1, leaves, world);
    	c.setBlockId(x+2, y+3, z, leaves, world);
    	c.setBlockId(x-2, y+3, z, leaves, world);
    	c.setBlockId(x, y+3, z+2, leaves, world);
    	c.setBlockId(x, y+3, z-2, leaves, world);
    	c.setBlockId(x+2, y+3, z+2, leaves, world);
    	c.setBlockId(x+2, y+3, z-2, leaves, world);
    	c.setBlockId(x+2, y+3, z-2, leaves, world);
    	c.setBlockId(x+2, y+3, z+2, leaves, world);
    	c.setBlockId(x+2, y+3, z-1, leaves, world);
    	c.setBlockId(x+1, y+3, z-2, leaves, world);
    	c.setBlockId(x-1, y+3, z-2, leaves, world);
    	c.setBlockId(x-2, y+3, z-1, leaves, world);
    	c.setBlockId(x-2, y+3, z+1, leaves, world);
    	c.setBlockId(x-1, y+3, z+2, leaves, world);
        ...
        // Fourth leaves layer
    	c.setBlockId(x+1, y+2, z, leaves, world);
    	c.setBlockId(x-1, y+2, z, leaves, world);
    	c.setBlockId(x, y+2, z+1, leaves, world);
    	c.setBlockId(x, y+2, z-1, leaves, world);
    	c.setBlockId(x+1, y+2, z+1, leaves, world);
    	c.setBlockId(x+1, y+2, z-1, leaves, world);
    	c.setBlockId(x-1, y+2, z-1, leaves, world);
    	c.setBlockId(x-1, y+2, z+1, leaves, world);
    	c.setBlockId(x+2, y+2, z, leaves, world);
    	c.setBlockId(x-2, y+2, z, leaves, world);
    	c.setBlockId(x, y+2, z+2, leaves, world);
    	c.setBlockId(x, y+2, z-2, leaves, world);
    	c.setBlockId(x+2, y+2, z+2, leaves, world);
    	c.setBlockId(x+2, y+2, z-2, leaves, world);
    	c.setBlockId(x+2, y+2, z-2, leaves, world);
    	c.setBlockId(x+2, y+2, z+2, leaves, world);
    	c.setBlockId(x+2, y+2, z-1, leaves, world);
    	c.setBlockId(x+1, y+2, z-2, leaves, world);
    	c.setBlockId(x-1, y+2, z-2, leaves, world);
    	c.setBlockId(x-2, y+2, z-1, leaves, world);
    	c.setBlockId(x-2, y+2, z+1, leaves, world);
    	c.setBlockId(x-1, y+2, z+2, leaves, world);
