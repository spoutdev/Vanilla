...
import org.spout.vanilla.generator.normal.decorator.MushroomDecorator;
...
public class SwampBiome extends VanillaBiomeType {
	...
	public SwampBiome() {
		super(6, new CactusDecorator(), new MushroomDecorator(), new GrassDecorator(), new OreDecorator(), new CaveDecorator(), new DungeonDecorator());
