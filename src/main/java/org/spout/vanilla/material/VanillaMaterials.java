...
import org.spout.vanilla.material.block.component.AnvilBlock;
...
import org.spout.vanilla.material.block.solid.JackOLantern;
...
public final class VanillaMaterials {
	...
	public static final Pumpkin PUMPKIN_BLOCK = Pumpkin.DIRECTIONS[0];
	...
	public static final JackOLantern JACK_O_LANTERN = JackOLantern.DIRECTIONS[0];
	...
	public static final Food COOKED_FISH = new Food("Cooked Fish", 350, null);
	public static final Food RED_APPLE = new Food("Apple", 260, null);
	public static final Food MUSHROOM_SOUP = new Food("Mushroom Soup", 282, null);
	public static final Food BREAD = new Food("Bread", 297, null);
	public static final RawPorkchop RAW_PORKCHOP = new RawPorkchop("Raw Porkchop", 319);
	public static final Food COOKED_PORKCHOP = new Food("Cooked Porkchop", 320, null);
	//	// TODO : Regen health for 4 secs
	public static final Food GOLDEN_APPLE = new Food("Golden Apple", 322, null);
	public static final Food MELON_SLICE = new Food("MelonBlock Slice", 360, null);
	public static final Food COOKIE = new Food("Cookie", 357, null);
	public static final RawBeef RAW_BEEF = new RawBeef("Raw Beef", 363);
	public static final Food STEAK = new Food("Steak", 364, null);
	public static final RawChicken RAW_CHICKEN = new RawChicken("Raw Chicken", 365);
	public static final Food COOKED_CHICKEN = new Food("Cooked Chicken", 366, null);
	public static final Food ROTTEN_FLESH = new Food("Rotten Flesh", 367, null);
	public static final Food CARROT = new Food("Carrot", 391, null);
	public static final Potato POTATO = new Potato("Potato", 392);
	public static final Food BAKED_POTATO = new Food("Baked Potato", 393, null);
	public static final Food POISONOUS_POTATO = new Food("Poisonous Potato", 394, null);
	public static final Food GOLDEN_CARROT = new Food("Golden Carrot", 396, null);
	public static final Food PUMPKIN_PIE = new Food("Pumpkin Pie", 400, null);
	// == Music Discs ==
