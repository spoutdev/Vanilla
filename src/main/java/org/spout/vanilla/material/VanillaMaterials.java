...
public final class VanillaMaterials {
	...
	public static final MelonBlock MELON_BLOCK = register(new MelonBlock("Melon", 103));
	...
	public static final PumpkinStem PUMPKIN_STEM = register(new PumpkinStem("Pumpkin Stem", 104));
	public static final MelonStem MELON_STEM = register(new MelonStem("Melon Stem", 105));
	...
	public static final NetherBrickFence NETHER_BRICK_FENCE = register(new NetherBrickFence("Nether Brick Fence", 113));
	...
	public static final BrewingStand BREWING_STAND_BLOCK = register(new BrewingStand("Brewing Stand", 117));
	...
	public static final IronHelmet IRON_HELMET = register(new IronHelmet("Iron Helmet", 306, 2));
	public static final GoldHelmet GOLD_HELMET = register(new GoldHelmet("Gold Helmet", 314, 2));
	public static final DiamondHelmet DIAMOND_HELMET = register(new DiamondHelmet("Diamond Helmet", 310, 3));
	//== Chestwear ==
	public static final LeatherTunic LEATHER_TUNIC = register(new LeatherTunic("Leather Tunic", 299, 3));
	public static final ChainChestplate CHAIN_CHESTPLATE = register(new ChainChestplate("Chain Chestplate", 303, 5));
	public static final IronChestplate IRON_CHESTPLATE = register(new IronChestplate("Iron Chestplate", 307, 6));
	public static final DiamondChestplate DIAMOND_CHESTPLATE = register(new DiamondChestplate("Diamond Chestplate", 311, 8));
	public static final GoldChestplate GOLD_CHESTPLATE = register(new GoldChestplate("Gold Chestplate", 315, 5));
	//== Legwear ==
	public static final LeatherPants LEATHER_PANTS = register(new LeatherPants("Leather Pants", 300, 2));
	public static final ChainLeggings CHAIN_LEGGINGS = register(new ChainLeggings("Chain Leggings", 304, 4));
	public static final IronLeggings IRON_LEGGINGS = register(new IronLeggings("Iron Leggings", 308, 5));
	public static final DiamondLeggings DIAMOND_LEGGINGS = register(new DiamondLeggings("Diamond Leggings", 312, 6));
	public static final GoldLeggings GOLD_LEGGINGS = register(new GoldLeggings("Gold Leggings", 316, 3));
	//== Footwear ==
	public static final LeatherBoots LEATHER_BOOTS = register(new LeatherBoots("Leather Boots", 301, 1));
	public static final ChainBoots CHAIN_BOOTS = register(new ChainBoots("Chain Boots", 305, 1));
	public static final IronBoots IRON_BOOTS = register(new IronBoots("Iron Boots", 309, 2));
	public static final DiamondBoots DIAMOND_BOOTS = register(new DiamondBoots("Diamond Boots", 313, 3));
	public static final GoldBoots GOLD_BOOTS = register(new GoldBoots("Gold Boots", 317, 1));
	...
	public static final Bow BOW = register(new Bow("Bow", 261, (short) 385));
