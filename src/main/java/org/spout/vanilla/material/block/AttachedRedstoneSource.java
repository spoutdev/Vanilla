...
public abstract class AttachedRedstoneSource extends AbstractAttachable implements RedstoneSource {
	...
	protected AttachedRedstoneSource(short dataMask, String name, int id, String model, CollisionShape shape) {
		super(dataMask, name, id, model, shape);
	}

	protected AttachedRedstoneSource(String name, int id, String model, CollisionShape shape) {
		super(name, id, model, shape);
	}

	public AttachedRedstoneSource(String name, int id, int data, VanillaBlockMaterial parent, String model, CollisionShape shape) {
