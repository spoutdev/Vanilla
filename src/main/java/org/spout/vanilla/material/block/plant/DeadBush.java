...
public class DeadBush extends GroundAttachable implements Plant {
	public DeadBush(String name, int id) {
		super(name, id, "model://Vanilla/resources/materials/block/nonsolid/deadgrass/deadgrass.spm");
		this.setLiquidObstacle(false);
		this.setHardness(0.0F).setResistance(0.0F).setTransparent();
	}

	public DeadBush(short dataMask, String name, int id) {
		super(dataMask, name, id, "model://Vanilla/resources/materials/block/nonsolid/deadgrass/deadgrass.spm");
		this.setLiquidObstacle(false);
		this.setHardness(0.0F).setResistance(0.0F).setTransparent();
	}

	public DeadBush(String name, int id, int data, VanillaBlockMaterial parent) {
		super(name, id, data, parent, "model://Vanilla/resources/materials/block/nonsolid/deadgrass/deadgrass.spm");
		this.setLiquidObstacle(false);
		this.setHardness(0.0F).setResistance(0.0F).setTransparent();
	}
