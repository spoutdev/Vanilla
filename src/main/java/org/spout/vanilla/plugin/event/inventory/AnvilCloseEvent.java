...
/**
 * Event which is called when an Anvil is closed.
 * todo implement calling of this event
 */
public class AnvilCloseEvent extends InventoryEvent implements Cancellable {
	private static HandlerList handlers = new HandlerList();
	private final Anvil anvil;
	private final Cause cause;

	public AnvilCloseEvent(Anvil anvil, Cause<?> reason) {
	...
	/**
	 * Returns the Cause which caused the AnvilCloseEvent
	 * @return cause
	 */
