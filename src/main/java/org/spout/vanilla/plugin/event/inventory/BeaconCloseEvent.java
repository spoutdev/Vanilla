...
/**
 * Event which is called when a Beacon is closed.
 * todo implement calling of this event
 */
public class BeaconCloseEvent extends InventoryEvent implements Cancellable {
	private static HandlerList handlers = new HandlerList();
	private final Beacon beacon;
	private final Cause cause;

	public BeaconCloseEvent(Beacon beacon, Cause<?> reason) {
		super(beacon.getInventory(),reason);
		this.beacon = beacon;
		this.cause = reason;
	}
	 ...
	 * @return beacon
	 */
	public Container getBeacon() {
		return beacon;
	}

	/**
	 * Returns the Cause which caused the BeaconCloseEvent
	 * @return cause
	 */
