...
/**
 * Event which is called when a Chest is opened / looked into.
 * todo implement calling of this event
 */
public class ChestOpenEvent extends InventoryEvent implements Cancellable {
	private static HandlerList handlers = new HandlerList();
	private final Chest chest;
	private final Cause cause;

	public ChestOpenEvent(Chest chest, Cause<?> reason) {
		super(chest,reason);
		this.chest = chest;
		this.cause = reason;
	}
	...
	/**
	 * Returns the Cause which caused the ChestOpenEvent
	 * @return cause
	 */
