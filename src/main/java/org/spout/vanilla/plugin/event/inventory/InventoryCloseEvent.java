...
/**
 * Event which is called when an inventory close event happens aka somebody closes a chest etc.
...
public class InventoryCloseEvent extends InventoryEvent implements Cancellable {
	...
	public InventoryCloseEvent(Container container, Cause<?> reason) {
