...
/**
 * Event which is called when an inventory open event happens aka somebody is looking into a furnace, villager etc.
...
public class InventoryOpenEvent extends InventoryEvent implements Cancellable {
	...
	public InventoryOpenEvent(Container container, Cause<?> reason) {
		super(container,reason);
