...
import org.spout.vanilla.plugin.material.block.component.JukeboxBlock;
import org.spout.vanilla.plugin.material.block.component.MonsterSpawnerBlock;
import org.spout.vanilla.plugin.material.block.component.NoteBlockBlock;
import org.spout.vanilla.plugin.material.block.component.PistonExtensionMoving;
import org.spout.vanilla.plugin.material.block.component.SignBase;
import org.spout.vanilla.plugin.material.block.component.SignPost;
import org.spout.vanilla.plugin.material.block.component.SkullBlock;
import org.spout.vanilla.plugin.material.block.component.WallSign;
import org.spout.vanilla.plugin.material.block.component.chest.ChestBlock;
import org.spout.vanilla.plugin.material.block.component.chest.EnderChestBlock;
import org.spout.vanilla.plugin.material.block.door.IronDoorBlock;
import org.spout.vanilla.plugin.material.block.door.WoodenDoorBlock;
import org.spout.vanilla.plugin.material.block.fence.NetherBrickFence;
import org.spout.vanilla.plugin.material.block.fence.Wall;
import org.spout.vanilla.plugin.material.block.fence.WoodenFence;
...
import org.spout.vanilla.plugin.material.block.misc.CakeBlock;
import org.spout.vanilla.plugin.material.block.misc.CommandBlock;
import org.spout.vanilla.plugin.material.block.misc.DecorativeDeadBush;
import org.spout.vanilla.plugin.material.block.misc.DragonEgg;
import org.spout.vanilla.plugin.material.block.misc.EndPortalFrame;
import org.spout.vanilla.plugin.material.block.misc.FarmLand;
import org.spout.vanilla.plugin.material.block.misc.FenceGate;
import org.spout.vanilla.plugin.material.block.misc.Fire;
import org.spout.vanilla.plugin.material.block.misc.FlowerPotBlock;
import org.spout.vanilla.plugin.material.block.misc.GlassPane;
import org.spout.vanilla.plugin.material.block.misc.Ladder;
import org.spout.vanilla.plugin.material.block.misc.Lever;
import org.spout.vanilla.plugin.material.block.misc.Slab;
import org.spout.vanilla.plugin.material.block.misc.Snow;
import org.spout.vanilla.plugin.material.block.misc.StoneButton;
import org.spout.vanilla.plugin.material.block.misc.TntBlock;
import org.spout.vanilla.plugin.material.block.misc.Torch;
import org.spout.vanilla.plugin.material.block.misc.TrapDoor;
import org.spout.vanilla.plugin.material.block.misc.TripWire;
import org.spout.vanilla.plugin.material.block.misc.TripWireHook;
import org.spout.vanilla.plugin.material.block.misc.Web;
import org.spout.vanilla.plugin.material.block.misc.WoodButton;
import org.spout.vanilla.plugin.material.block.ore.CoalOre;
import org.spout.vanilla.plugin.material.block.ore.DiamondBlock;
import org.spout.vanilla.plugin.material.block.ore.DiamondOre;
import org.spout.vanilla.plugin.material.block.ore.EmeraldBlock;
import org.spout.vanilla.plugin.material.block.ore.EmeraldOre;
import org.spout.vanilla.plugin.material.block.ore.Glowstone;
import org.spout.vanilla.plugin.material.block.ore.GoldBlock;
import org.spout.vanilla.plugin.material.block.ore.GoldOre;
import org.spout.vanilla.plugin.material.block.ore.IronBlock;
import org.spout.vanilla.plugin.material.block.ore.IronOre;
...
import org.spout.vanilla.plugin.material.block.plant.Cactus;
import org.spout.vanilla.plugin.material.block.plant.Carrots;
import org.spout.vanilla.plugin.material.block.plant.CocoaPlant;
import org.spout.vanilla.plugin.material.block.plant.Flower;
import org.spout.vanilla.plugin.material.block.plant.LilyPad;
import org.spout.vanilla.plugin.material.block.plant.MelonStem;
import org.spout.vanilla.plugin.material.block.plant.Mushroom;
import org.spout.vanilla.plugin.material.block.plant.NetherWartBlock;
import org.spout.vanilla.plugin.material.block.plant.Potatoes;
import org.spout.vanilla.plugin.material.block.plant.PumpkinStem;
import org.spout.vanilla.plugin.material.block.plant.Sapling;
import org.spout.vanilla.plugin.material.block.plant.SugarCaneBlock;
import org.spout.vanilla.plugin.material.block.plant.TallGrass;
import org.spout.vanilla.plugin.material.block.plant.Vines;
import org.spout.vanilla.plugin.material.block.plant.WheatCrop;
import org.spout.vanilla.plugin.material.block.portal.EndPortal;
import org.spout.vanilla.plugin.material.block.portal.NetherPortal;
import org.spout.vanilla.plugin.material.block.pressureplate.StonePressurePlate;
import org.spout.vanilla.plugin.material.block.pressureplate.WoodenPressurePlate;
...
import org.spout.vanilla.plugin.material.block.solid.Bedrock;
import org.spout.vanilla.plugin.material.block.solid.BookShelf;
import org.spout.vanilla.plugin.material.block.solid.Brick;
import org.spout.vanilla.plugin.material.block.solid.CauldronBlock;
import org.spout.vanilla.plugin.material.block.solid.ClayBlock;
import org.spout.vanilla.plugin.material.block.solid.Cobblestone;
import org.spout.vanilla.plugin.material.block.solid.Dirt;
import org.spout.vanilla.plugin.material.block.solid.DoubleSlab;
import org.spout.vanilla.plugin.material.block.solid.Endstone;
import org.spout.vanilla.plugin.material.block.solid.Glass;
import org.spout.vanilla.plugin.material.block.solid.Grass;
...
import org.spout.vanilla.plugin.material.block.solid.SilverfishStone;
import org.spout.vanilla.plugin.material.block.solid.SnowBlock;
import org.spout.vanilla.plugin.material.block.solid.SoulSand;
...
import org.spout.vanilla.plugin.material.block.stair.StoneBrickStairs;
import org.spout.vanilla.plugin.material.item.BlockItem;
import org.spout.vanilla.plugin.material.item.Food;
import org.spout.vanilla.plugin.material.item.VanillaItemMaterial;
import org.spout.vanilla.plugin.material.item.armor.chain.ChainBoots;
import org.spout.vanilla.plugin.material.item.armor.chain.ChainChestplate;
import org.spout.vanilla.plugin.material.item.armor.chain.ChainHelmet;
import org.spout.vanilla.plugin.material.item.armor.chain.ChainLeggings;
import org.spout.vanilla.plugin.material.item.armor.diamond.DiamondBoots;
import org.spout.vanilla.plugin.material.item.armor.diamond.DiamondChestplate;
import org.spout.vanilla.plugin.material.item.armor.diamond.DiamondHelmet;
import org.spout.vanilla.plugin.material.item.armor.diamond.DiamondLeggings;
import org.spout.vanilla.plugin.material.item.armor.gold.GoldBoots;
import org.spout.vanilla.plugin.material.item.armor.gold.GoldChestplate;
import org.spout.vanilla.plugin.material.item.armor.gold.GoldHelmet;
import org.spout.vanilla.plugin.material.item.armor.gold.GoldLeggings;
import org.spout.vanilla.plugin.material.item.armor.iron.IronBoots;
import org.spout.vanilla.plugin.material.item.armor.iron.IronChestplate;
import org.spout.vanilla.plugin.material.item.armor.iron.IronHelmet;
import org.spout.vanilla.plugin.material.item.armor.iron.IronLeggings;
import org.spout.vanilla.plugin.material.item.armor.leather.LeatherBoots;
import org.spout.vanilla.plugin.material.item.armor.leather.LeatherCap;
import org.spout.vanilla.plugin.material.item.armor.leather.LeatherPants;
import org.spout.vanilla.plugin.material.item.armor.leather.LeatherTunic;
import org.spout.vanilla.plugin.material.item.bucket.EmptyBucket;
import org.spout.vanilla.plugin.material.item.bucket.FullBucket;
import org.spout.vanilla.plugin.material.item.bucket.LavaBucket;
import org.spout.vanilla.plugin.material.item.food.Potato;
import org.spout.vanilla.plugin.material.item.food.RawBeef;
import org.spout.vanilla.plugin.material.item.food.RawChicken;
import org.spout.vanilla.plugin.material.item.food.RawFish;
import org.spout.vanilla.plugin.material.item.food.RawPorkchop;
import org.spout.vanilla.plugin.material.item.misc.ItemFrameItem;
import org.spout.vanilla.plugin.material.item.vehicle.BoatItem;
import org.spout.vanilla.plugin.material.item.vehicle.minecart.MinecartItem;
import org.spout.vanilla.plugin.material.item.vehicle.minecart.PoweredMinecartItem;
import org.spout.vanilla.plugin.material.item.vehicle.minecart.StorageMinecartItem;
...
import org.spout.vanilla.plugin.material.item.misc.Skull;
import org.spout.vanilla.plugin.material.item.misc.SnowballItem;
...
public final class VanillaMaterials {
	...
	public static final BlockItem SEEDS = new BlockItem("Seeds", 295, WHEATCROP, null);
	...
	public static final VanillaItemMaterial SUGAR = new VanillaItemMaterial("Sugar", 353, null);
	...
	public static final VanillaItemMaterial NETHER_WART = new VanillaItemMaterial("Nether Wart", 372, null);
	...
	public static final VanillaItemMaterial BLAZE_POWDER = new VanillaItemMaterial("Blaze Powder", 377, null);
