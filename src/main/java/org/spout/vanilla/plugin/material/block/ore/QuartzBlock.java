...
public class QuartzBlock extends Solid {
	...
	private QuartzBlock(String name, ResourcePointer<Model> model) {
	...
	private QuartzBlock(String name, QuartzBlockType type, QuartzBlock parent, ResourcePointer<Model> model) {
