...
import org.spout.vanilla.protocol.handler.player.PlayerPositionYawHandler;
...
public class VanillaHandlerLookupService extends HandlerLookupService {
	public VanillaHandlerLookupService() {
		try {
			...
			bind(PlayerYawMessage.class, PlayerYawHandler.class);
			bind(PlayerPositionYawMessage.class, PlayerPositionYawHandler.class);
