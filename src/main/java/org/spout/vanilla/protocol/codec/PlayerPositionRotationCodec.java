...
public final class PlayerPositionRotationCodec extends MessageCodec<PlayerPositionRotationMessage> {
	public PlayerPositionRotationCodec() {
		super(PlayerPositionRotationMessage.class, 0x0D);
	}
	...
	public PlayerPositionRotationMessage decode(ChannelBuffer buffer) throws IOException {
		...
		return new PlayerPositionRotationMessage(x, y, z, stance, rotation, pitch, onGround);
	}
