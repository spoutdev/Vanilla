...
public final class PlayerRotationCodec extends MessageCodec<PlayerRotationMessage> {
	public PlayerRotationCodec() {
		super(PlayerRotationMessage.class, 0x0C);
	}
	...
	public PlayerRotationMessage decode(ChannelBuffer buffer) throws IOException {
		...
		return new PlayerRotationMessage(rotation, pitch, onGround);
	}
