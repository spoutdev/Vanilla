...
public final class EntitySpawnMobCodec extends MessageCodec<EntitySpawnMobMessage> {
	public EntitySpawnMobCodec() {
		super(EntitySpawnMobMessage.class, 0x18);
	}

	@Override
	public EntitySpawnMobMessage decode(ChannelBuffer buffer) throws IOException {
		...
		return new EntitySpawnMobMessage(id, type, x, y, z, yaw, pitch, headYaw, velocityZ, velocityX, velocityY, parameters);
	}

	@Override
	public ChannelBuffer encode(EntitySpawnMobMessage message) throws IOException {
