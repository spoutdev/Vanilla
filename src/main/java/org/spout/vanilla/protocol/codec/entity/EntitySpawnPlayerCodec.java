...
public final class EntitySpawnPlayerCodec extends MessageCodec<EntitySpawnPlayerMessage> {
	public EntitySpawnPlayerCodec() {
		super(EntitySpawnPlayerMessage.class, 0x14);
	}

	@Override
	public EntitySpawnPlayerMessage decode(ChannelBuffer buffer) throws IOException {
