...
public final class EntitySpawnVehicleCodec extends MessageCodec<EntitySpawnVehicleMessage> {
	public EntitySpawnVehicleCodec() {
		super(EntitySpawnVehicleMessage.class, 0x17);
	}

	@Override
	public EntitySpawnVehicleMessage decode(ChannelBuffer buffer) throws IOException {
		...
		if (fireballId != 0) {
			...
			return new EntitySpawnVehicleMessage(id, type, x, y, z, fireballId, fireballX, fireballY, fireballZ);
		}
		return new EntitySpawnVehicleMessage(id, type, x, y, z);
	}

	@Override
	public ChannelBuffer encode(EntitySpawnVehicleMessage message) throws IOException {
