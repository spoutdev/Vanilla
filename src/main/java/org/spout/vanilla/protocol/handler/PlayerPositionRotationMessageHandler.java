...
public final class PlayerPositionRotationMessageHandler extends MessageHandler<PlayerPositionRotationMessage> {
	@Override
	public void handleServer(Session session, Player player, PlayerPositionRotationMessage message) {
		if (player == null) {
			return;
		}
