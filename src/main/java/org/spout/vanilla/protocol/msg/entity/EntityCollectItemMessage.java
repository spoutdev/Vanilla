...
public final class EntityCollectItemMessage extends EntityMessage {
	private int collector;

	public EntityCollectItemMessage(int id, int collector) {
		super(id);
	...
	public boolean equals(Object obj) {
		...
		final EntityCollectItemMessage other = (EntityCollectItemMessage) obj;
