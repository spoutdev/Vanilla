...
public final class EntitySpawnMobMessage extends EntityMessage {
	...
	public EntitySpawnMobMessage(int id, int type, Vector3 pos, int yaw, int pitch, int headYaw, short velocityZ, short velocityX, short velocityY, List<Parameter<?>> parameters) {
		this(id, type, (int) pos.getX(), (int) pos.getY(), (int) pos.getZ(), yaw, pitch, headYaw, velocityZ, velocityX, velocityY, parameters);
	}

	public EntitySpawnMobMessage(int id, int type, int x, int y, int z, int yaw, int pitch, int headYaw, short velocityZ, short velocityX, short velocityY, List<Parameter<?>> parameters) {
		super(id);
		this.type = type;
		this.x = x;
		this.y = y;
	...
	public boolean equals(Object obj) {
		...
		final EntitySpawnMobMessage other = (EntitySpawnMobMessage) obj;
