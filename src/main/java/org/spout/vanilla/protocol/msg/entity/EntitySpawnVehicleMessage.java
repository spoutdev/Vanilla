...
public final class EntitySpawnVehicleMessage extends EntityMessage {
	private final int type, fireballId;
	private final double x, y, z, fireballX, fireballY, fireballZ;

	public EntitySpawnVehicleMessage(int id, int type, Vector3 pos) {
		this(id, type, pos.getX(), pos.getY(), pos.getZ());
	}

	public EntitySpawnVehicleMessage(int id, int type, double x, double y, double z) {
		this(id, type, x, y, z, 0, 0, 0, 0);
	}

	public EntitySpawnVehicleMessage(int id, int type, Vector3 pos, int fbId, Vector3 fbPos) {
		this(id, type, pos.getX(), pos.getY(), pos.getZ(), fbId, fbPos.getX(), fbPos.getY(), fbPos.getZ());
	}

	public EntitySpawnVehicleMessage(int id, int type, double x, double y, double z, int fbId, double fbX, double fbY, double fbZ) {
		super(id);
		this.type = type;
		this.x = x;
		this.y = y;
	...
	public boolean equals(Object obj) {
		...
		final EntitySpawnVehicleMessage other = (EntitySpawnVehicleMessage) obj;
