...
public final class EntityUseBedMessage extends EntityMessage {
	// TODO: find a better name then used and possably rename this whole class
	private final int used, x, y, z;

	public EntityUseBedMessage(int id, int used, int x, int y, int z) {
		super(id);
		this.used = used;
		this.x = x;
		this.y = y;
	...
	public boolean equals(Object obj) {
		...
		final EntityUseBedMessage other = (EntityUseBedMessage) obj;
