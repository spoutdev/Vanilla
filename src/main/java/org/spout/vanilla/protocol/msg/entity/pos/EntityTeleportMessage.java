...
public final class EntityTeleportMessage extends EntityMessage {
	...
	public EntityTeleportMessage(int id, Vector3 position, int rotation, int pitch, RepositionManager rm) {
		this(id, (int) position.getX(), (int) position.getY(), (int) position.getZ(), rotation, pitch, rm);
	}

	public EntityTeleportMessage(int id, int x, int y, int z, int rotation, int pitch, RepositionManager rm) {
		super(id);
