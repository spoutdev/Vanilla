...
public class TaigaLayer implements BiomeSelectorLayer {
	...
	public TaigaLayer(double scale) {
	...
	public BiomeSelectorElement pick(int x, int y, int z, long seed) {
		...
		final BiomeSelectorElement river = NormalBiomeSelector.FROZEN_RIVER.pick(x, y, z, seed);
		if (river == null) {
